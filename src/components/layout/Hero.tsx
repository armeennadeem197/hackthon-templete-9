  ...
  return (
    <div className='lg:flex lg:gap-[100px] lg:px-[100px] px-6 lg:pt-[101px] pt-[50px]' >
      ...
      <div className='lg:w-[472px] w-[300px] lg:h-[356px] rounded-[30px] flex flex-col lg:gap-[20px] gap-[25px] '>
        ...
        <Link href={"/shop"}><button className='lg:w-[150px] w-[100px] h-[30px] lg:h-[50px] rounded-[30px] bg-bordercoloryello text-whitetext'>See Menu</button></Link>
      </div>
      <div>
        <Image src={heroimg} alt='' className='"w-[200px] h-auto lg:w-[600px] lg:h-[425px] object-cover rounded-[20px] lg:rounded-[30px]'/>
      </div>
    </div>
  )
}
